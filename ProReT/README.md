...
Both illustrative cNMF systems are available directly from the package:

| System | Variant | Genes | Programs | Precomputed LINCS scope |
|---|---:|---:|---:|---|
| K562 | common | 5,927 | 50 | 5,927 shared genes |
| K562 | complete | 8,139 | 50 | 5,927 K562-LINCS BING genes |
...
native LINCS BING intersection. K562 and KOLF are examples of the general
