...
drug_reference$projection_checksum <- basis_projection_checksum(basis, core)
drug_reference$payload_checksum <- drug_payload_checksum(
  drug_reference$signatures, drug_reference$core_genes,
  drug_reference$program_names, drug_reference$projection_checksum
)
